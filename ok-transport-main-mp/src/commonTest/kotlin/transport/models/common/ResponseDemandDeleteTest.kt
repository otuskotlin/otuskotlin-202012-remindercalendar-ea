...
internal class ResponseDemandDeleteTest {
    @Test
    fun serializationResponseDemandDeleteTest() {
        val json = Json {
            prettyPrint = true
            serializersModule = SerializersModule {
                polymorphic(MpMessage::class) {
                    subclass(MpResponseDemandDelete::class, MpResponseDemandDelete.serializer())
                }
        ...
        val dto: MpMessage = MpResponseDemandDelete(
        ...
        assertEquals("response-id", (deserializedDto as? MpResponseDemandDelete)?.responseId)
    }
}